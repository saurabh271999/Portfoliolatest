...
const X = {
  ...
  /** 👇👇👇 THIS IS IMPORTANT 👇👇👇 */
  controlSphere0: false,     // Disable any interactive control sphere
  followCursor: false,       // Disable mouse tracking
  mouseAttract: false,       // 👈 If supported, also disable this
  attractStrength: 0,        // 👈 Optional: stop any magnet effect
};
